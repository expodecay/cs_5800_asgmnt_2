...
public class TestPizzaBuilder {
    public static void main(String[] args) {
        ...
        //PizzaDirector pizza_hut_director_2 = new PizzaDirector(pizza_hut_builder_1);
        ...
        pizza_hut_director_1.makePizza("Small", new String[]{"Pepperoni", "Sausage"});
        Pizza pizza_hut_pizza_2 = pizza_hut_director_1.getPizza();
